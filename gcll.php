...
echo <<<EOT
<!-- Start Of Script Generated By Greg's Comment Length Limiter Plugin 1.0 -->
...
<!-- End of Script Generated By Greg's Comment Length Limiter Plugin 1.0 -->
EOT;
} 
return;
} 
...
$message = str_replace('%THIS_PLUGIN%','<a href="http://counsellingresource.com/features/2009/02/04/comment-length-limiter-plugin/">Greg&#8217;s Comment Length Limiter plugin</a>',get_option('gcll_thank_you_message'));
echo '<p>' . $message . '</p>';
} 
return;
}
